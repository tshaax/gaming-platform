...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-violet-900 flex items-center justify-center px-4">
      <div class="w-full max-w-md">
        <div class="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
          <div class="text-center mb-8">
            ...
            <h1 class="text-4xl font-bold text-white mb-2">Playground</h1>
            <p class="text-purple-200">Login to your gaming account</p>
          </div>

          <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-6">
            <!-- Credential Type Toggle -->
            <div>
              <p class="block text-sm font-medium text-purple-100 mb-3">Login With</p>
              <div class="flex gap-2">
                <button
                  type="button"
                  (click)="toggleCredentialType()"
                  [class.bg-purple-600]="credentialType() === 'email'"
                ...
                <button
                  type="button"
                  (click)="toggleCredentialType()"
                  [class.bg-purple-600]="credentialType() === 'cellphone'"
            ...
            <div>
              <label [for]="'credential-input'" class="block text-sm font-medium text-purple-100 mb-2">
              ...
              <input
                ...
                [placeholder]="credentialType() === 'email' ? 'you@example.com' : '+1 (555) 000-0000'"
                class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-purple-300 focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50"
              />
            </div>
            ...
            <button
              ...
              class="w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              @if (isLoading()) {
